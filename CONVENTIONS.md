...
- The authoritative Python 3.12 CI coverage artifact measures **92.46%
  (3824/4136)**. The active 98% target is not yet met, and CI enforcement
...
- The 81% measurement is historical evidence. The current authoritative Python 3.12
  CI artifact measures 92.46% (3824/4136). Issue #69 tracks reaching 98% without
