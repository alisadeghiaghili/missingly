...
- The authoritative Python 3.12 CI coverage artifact measures **92.47%
  (3830/4142)**. The active 98% target is not yet met, and CI enforcement
...
- The 81% measurement is historical evidence. The current authoritative Python 3.12
  CI artifact measures 92.47% (3830/4142). Issue #69 tracks reaching 98% without
